            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>Fin de Sesion</th>
                        <th>Nombre del Curso Asociado</th>
                        <th>Nombre de la Plantilla Asociado</th>
                ...
                <tbody class="buscar">
                    @foreach ($sesiones as $sesion)
                        <tr>
                            ...
                            @isset($sesion->curso->cursonombre)
                                <td>{{ $sesion->curso->cursonombre}}</td>
                            @else
                                <td>-- Sin Curso asociado --</td>
                            @endisset
                            @isset($sesion->plantilla->plantillanombre)
                                <td>{{ $sesion->plantilla->plantillanombre}}</td>
                            @else
